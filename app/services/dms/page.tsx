    ...
    <main className="relative mx-auto flex min-h-screen max-w-3xl flex-col gap-10 px-4 py-12 pt-28 md:px-12">
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Managing diagnostic workflows shouldn’t be complicated. Our Diagnostic Management System
          automates the entire process—from test scheduling to result generation—making it easy for
          hospitals and labs to deliver quick and accurate reports without paperwork.
        </p>
      </motion.section>
