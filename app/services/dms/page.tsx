...
const features = [
  ...
  'Automated reporting and instant patient notifications',
    ...
    <main className="min-h-screen pt-28 py-12 px-4 md:px-12 max-w-3xl mx-auto flex flex-col gap-10 relative">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-primary-500 to-blue-500 bg-clip-text text-transparent">
          Faster, Smarter, and More Accurate Diagnostics
        </h1>
        <motion.div
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Managing diagnostic workflows shouldn’t be complicated. Our Diagnostic Management System automates the entire process—from test scheduling to result generation—making it easy for hospitals and labs to deliver quick and accurate reports without paperwork.
        </p>
      </motion.section>
