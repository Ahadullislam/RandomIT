    ...
    <main className="relative mx-auto flex min-h-screen max-w-3xl flex-col gap-10 px-4 py-12 pt-28 md:px-12">
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          No more misplaced files or delayed treatments. Our EHR system keeps medical histories,
          prescriptions, and lab reports organized, secure, and accessible anytime, from anywhere.
        </p>
      </motion.section>
      <motion.section
        initial={{ opacity: 0, y: 40 }}
