...
const features = [
  ...
  'Supplier and vendor management for seamless procurement',
  'Cost optimization and detailed reporting',
];
    ...
    <main className="min-h-screen pt-28 py-12 px-4 md:px-12 max-w-3xl mx-auto flex flex-col gap-10 relative">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-primary-500 to-blue-500 bg-clip-text text-transparent">
          Efficiently Manage Your Medical Supplies & Equipment
        </h1>
        <motion.div
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Never run out of critical supplies or overstock again. Our Inventory Management System ensures optimal stock levels, reduces waste, and simplifies supply chain management for hospitals, laboratories, and healthcare facilities.
        </p>
      </motion.section>
      <motion.section
        initial={{ opacity: 0, y: 40 }}
