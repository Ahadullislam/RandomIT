    ...
    <main className="relative mx-auto flex min-h-screen max-w-3xl flex-col gap-10 px-4 py-12 pt-28 md:px-12">
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Never run out of critical supplies or overstock again. Our Inventory Management System
          ensures optimal stock levels, reduces waste, and simplifies supply chain management for
