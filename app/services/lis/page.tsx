...
const features = [
  'Barcode-based sample tracking for accuracy',
  'Seamless integration with diagnostic machines',
  'Instant result sharing with doctors & patients',
];
    ...
    <main className="min-h-screen pt-28 py-12 px-4 md:px-12 max-w-3xl mx-auto flex flex-col gap-10 relative">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold mb-2 bg-gradient-to-r from-primary-500 to-blue-500 bg-clip-text text-transparent">
          Making Lab Testing Faster & More Efficient
        </h1>
        <motion.div
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Our Lab Investigation System helps laboratories manage samples, track progress, and deliver results faster. With automated workflows and real-time tracking, labs can work more efficiently while reducing errors.
        </p>
      </motion.section>
      <motion.section
        initial={{ opacity: 0, y: 40 }}
