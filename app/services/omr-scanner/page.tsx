    ...
    <main className="min-h-screen pt-28 py-12 px-4 md:px-12 max-w-3xl mx-auto flex flex-col gap-10 relative">
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-200">
          Our OMR (Optical Mark Recognition) Scanner System is a cutting-edge solution designed to automate and streamline the processing of multiple-choice documents such as exams, surveys, and evaluation sheets. It accurately detects filled bubbles, reads roll numbers or IDs, compares answers with an answer key, and generates insightful reports — all in just a few clicks.
        </p>
      </motion.section>
      <motion.section
        initial={{ opacity: 0, y: 40 }}
      ...
      <motion.section
        ...
        className="bg-white/80 dark:bg-gray-800/80 rounded-xl p-6 shadow-md backdrop-blur-md"
      >
        <h2 className="text-2xl font-semibold mb-4 text-primary-700 dark:text-primary-300">Perfect For</h2>
        <ul className="space-y-2">
          {perfectFor.map((item, idx) => (
            ...
            >
              <span className="inline-block w-4 h-4 bg-primary-400 rounded-full"></span>
              {item}
            </motion.li>
          ))}
        </ul>
