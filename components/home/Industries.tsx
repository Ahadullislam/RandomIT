    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0 2 2 0 000-4z"
        />
      </svg>
    ),
...
export default function Industries() {
  ...
  return (
    <section className="bg-gray-50 py-16 dark:bg-gray-800/50 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-gray-300">
            We understand the unique challenges of different industries and provide specialized
        ...
        >
          {industries.map((industry, index) => (
            <motion.div
              key={index}
              variants={item}
              className="group relative rounded-xl bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:bg-gray-800"
            >
              <div
                className={`mb-4 inline-flex h-14 w-14 items-center justify-center rounded-lg ${industry.bgColor} ${industry.color}`}
              >
                {industry.icon}
              </div>
        ...
        >
          <p className="mb-6 text-lg text-gray-600 dark:text-gray-300">
            Don't see your industry? We can create custom solutions for your specific needs.
          </p>
          <a
            href="/contact"
