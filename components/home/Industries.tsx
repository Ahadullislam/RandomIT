  ...
  return (
    <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-800/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-sm font-semibold tracking-wider text-primary-600 uppercase">Industries We Serve</span>
          <h2 className="mt-2 text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl md:text-5xl">
            Tailored Solutions for Every Industry
          </h2>
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            We understand the unique challenges of different industries and provide specialized solutions to address them.
          </p>
        </motion.div>
        ...
        >
          {industries.map((industry, index) => (
            <motion.div
              key={index}
              variants={item}
              className="group relative p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              <div className={`inline-flex items-center justify-center w-14 h-14 rounded-lg mb-4 ${industry.bgColor} ${industry.color}`}>
                {industry.icon}
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{industry.name}</h3>
              <p className="text-gray-600 dark:text-gray-300">{industry.description}</p>
              <div className="mt-4">
                <span className="inline-flex items-center text-sm font-medium text-primary-600 dark:text-primary-400 group-hover:underline">
                  Learn more
